...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_EVERFLOWRESTOREDHP]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} refuses to fall!"), // Restores 1/2 max HP once per battle
    ...
    [STRINGID_SYLVANSANCTUARYACTIVATES]             = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s side is cloaked in a mystical veil!"),
    [STRINGID_SYLVANWARDACTIVATES]                  = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s protective veil strengthened!"),
    [STRINGID_VICIOUSRENDACTIVATES]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} became relentless!"),
    ...
    [STRINGID_MOSTLYINEFFECTIVETWOFOES]             = COMPOUND_STRING("It's mostly ineffective against {B_DEF_NAME_WITH_PREFIX2} and {B_DEF_PARTNER_NAME}…"),
    ...
    // Sabotage Battles
    [STRINGID_TRAPPERSTERRITORYACTIVATES]    = COMPOUND_STRING("Pokémon can no longer escape!"),
    [STRINGID_GRAVEYARDACTIVATES]            = COMPOUND_STRING("All Pokémon gained the Ghost-type!"),
};
...
const u16 gSwitchInAbilityStringIds[] =
{
    ...
    [B_MSG_SWITCHIN_SYLVAN_SANCTUARY] = STRINGID_SYLVANSANCTUARYACTIVATES,
    [B_MSG_SWITCHIN_SYLVAN_WARD] = STRINGID_SYLVANWARDACTIVATES,
    [B_MSG_SWITCHIN_VICIOUS_REND] = STRINGID_VICIOUSRENDACTIVATES
};
...
const u16 gSabotage_TrapActivationMsgIds[] = 
{
    [B_MSG_TRAPPERS_TERRITORY_ACTIVATES] = STRINGID_TRAPPERSTERRITORYACTIVATES,
    [B_MSG_GRAVEYARD_ACTIVATES] = STRINGID_GRAVEYARDACTIVATES,
};
