...
{
    { COMPOUND_STRING("Test Battle"), DebugAction_ExecuteScript, Debug_EventScript_Script_1 },
    { COMPOUND_STRING("Evolution Test"), DebugAction_ExecuteScript, Debug_EventScript_Script_2 },
