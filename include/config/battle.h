...
#define B_FLAG_SABOTAGE_BATTLE      0x900 // If this flag is set, the battle is a sabotage battle where the opponent's Pokémon have held items that negatively affect the player's Pokémon when they are switched in.
