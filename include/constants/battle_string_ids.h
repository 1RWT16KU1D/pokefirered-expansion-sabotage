...
enum StringID
{
    ...
    STRINGID_SYLVANSANCTUARYACTIVATES,
    STRINGID_SYLVANWARDACTIVATES,
    STRINGID_VICIOUSRENDACTIVATES,
    ...
    // Custom Moves
    STRINGID_TARGET_STAT_CHANGES_WERE_RESET,
...
enum SwitchInAbilityStringID
{
    ...
    B_MSG_SWITCHIN_SYLVAN_SANCTUARY,
    B_MSG_SWITCHIN_SYLVAN_WARD,
    B_MSG_SWITCHIN_VICIOUS_REND,
};
